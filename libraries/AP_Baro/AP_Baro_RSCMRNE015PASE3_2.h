...
class AP_Baro_RSCMRNE015PASE3_2 : public AP_Baro_Backend
{
public:
    ...
    static AP_Baro_Backend *probe(AP_Baro &baro, AP_HAL::OwnPtr<AP_HAL::Device> dev, enum RSCMRNE_TYPE rscmrne_type = BARO_015PASE3_2); // BARO_015PASE3_2
...
private:
    ...
    AP_Baro_RSCMRNE015PASE3_2(AP_Baro &baro, AP_HAL::OwnPtr<AP_HAL::Device> dev, enum RSCMRNE_TYPE rscmrne_type);
    ...
    uint32_t _read_adc();
    bool _init_adc(void);
    bool _adc_cmd_reset(uint8_t * pValue);
    ...
    void _calculate_rscmrne015(void);
