 ...
 *
 *   \details  The source contains functions which:
 *             1. Look up table of CCITT CRC 16
 *             2. Function to calculate the CRC
 *
 *   \author   Kantha
 *
 *   \date     10.07.2014
...
/*! \var      uint16_t gu16Crc16Table[256]
 *  \brief    Table to implement CRC_CCITT Polynomial =
 ...
 *  \details  computes the 16-bit CRC-16-CCITT checksum . This function will use
 *            lookup table approach to compute the CRC-16-CCITT checksum with
 *            Generator Polynomial = 0x1021  
 *  \param    u8Data - Data
 *            u16CurrCrc - Current CRC
 *  \return   void
 *
 *  \verbatim
    \endverbatim
...
{
    /*! Find the look up table index */
    unsigned char iTable = (u8Data ^ (u16CurrCrc >> 8));

    /*! Calculate the new CRC */
    u16CurrCrc = (gu16Crc16Table[iTable] ^ (u16CurrCrc << 8));
